...
This eventually breaks down, in fact for a large enough $n$ there exists a graph for any given girth and chromatic number\cite{erdos1959graph}.
...
\begin{figure}[t]
\begin{center}
  \includegraphics[width=0.75\textwidth]{simple_drawings/ex_query.png}
\end{center}
  \caption{
