...
A graph is \textit{triangle free} (\textit{square free}) if $\VARsubgraph(g,C_3)=0$ ($\VARsubgraph(g,C_4)=0$) where $C_n$ is the cycle graph on $n$ vertices.
