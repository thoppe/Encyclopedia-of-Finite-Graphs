...
Even with indexing this arrangement was not optimal for sequence-like queries.
...
Primary sequences are those involving a single invariant while secondary sequences involve the union of two invariants.
...
\toprule
OEIS & Invariant & 
\multicolumn{10}{l}{Sequence: \ $S_1, S_2, \ldots, S_{10}$, terms in $(\cdot)$ were added by this project} 
\\
\midrule\bottomrule
