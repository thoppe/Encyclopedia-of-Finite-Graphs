...
Discuss which algorithm was used, the software, \texttt{networkx} \needref, \texttt{graph-tool} \needref, etc...
...
A \textit{clique} is a subgraph of a graph that is complete. The \textit{maximum clique number} of graph $G$ is the cardinality of the largest clique in $G$. 

\note{Add a picture of these graphs}
