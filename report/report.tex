...
This particular sequence is well-known and is easily computable.
...
This can be efficiently stored as a 64 bit unsigned integer using two's complement representation.
...
For example, one of the equality relations state that, a graph is a tree $\Leftrightarrow$ a graph has zero girth.
