...
There are no unit tests on girth, (can use oeis.org/A184943)
...
There are no unit tests for these (can use the fact that `distance_regular=1` and `diameter=2` is http://oeis.org/A088741)
...
+ [`A158007`](https://oeis.org/A158007) `0,1,1,5,17,104,816,10933,259298,11685545,1005551939,163973291348,50323109433351`

*`[is_eulerian=1]`*, `1,0,1,1,4,8,37,184,1782,31026`
+ [`A003049`](https://oeis.org/A003049) `1,0,1,1,4,8,37,184,1782,31026,1148626,86539128,12798435868`
...
+ [`A024607`](https://oeis.org/A024607) `1,1,1,3,6,19,59,267,1380,9832,90842,1144061,19425052`
